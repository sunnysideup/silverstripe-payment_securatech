...
class SecurePayTechPayment extends Payment
{
    ...
    public function getPaymentFormFields()
    {
		...
		');
        $paymentsList.='<img height="30" src="payment_securatech/images/paymark_small.png" alt="Paymark Certified" onclick="paymark_verify (' . "'" . self::get_spt_merchant_id() . "'" . ')" class="last" /></div>';
    ...
    public function http_post($method, $server, $port, $url, $vars)
    {
        $postdata = "";
