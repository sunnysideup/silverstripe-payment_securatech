...
class SecurePayTechPaymentHosted extends Payment
{
    ...
    public static function set_spt_merchant_id($spt_merchant_id)
    {
        self::$spt_merchant_id = $spt_merchant_id;
    }
    public static function get_spt_merchant_id()
    {
        if (! Director::isLive()) {
            return 'TESTDIGISPL1';
        } else {
    ...
    public static function set_spt_merchant_key($spt_merchant_key)
    {
        self::$spt_merchant_key = $spt_merchant_key;
    }

    protected static $merchant_url = 'https://merchant.securepaytech.com/paymentpage/index.php';
    public static function set_merchant_url($s)
    {
        self::$merchant_url = $s;
    }
    public static function get_merchant_url()
    {
    ...
    public function processPaymentForm($data)
    {
        $order = $this->Order();
...
class SecurePayTechPaymentHosted_Handler extends Controller
{
    ...
    public static $URLSegment = 'paytech';
    ...
    public static function success_link(SecurePayTechPaymentHosted $payment)
    {
        return self::$URLSegment . "/success/$payment->ID-$payment->AuthorisationCode";
    }

    public static function cancel_link(SecurePayTechPaymentHosted $payment)
    {
